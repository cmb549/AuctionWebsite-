...
<%
    ...
    ResultSet rs;
    rs = st.executeQuery("select * from customer_rep where username='" + userid + "'");
    if (rs.next()) {
    	out.println("Username already taken,");
    	out.println("<a href='CreateCRAcc.jsp'>try again</a>");
    	...
    	String queryStr = "INSERT INTO customer_rep(username, password, name, phone, email) VALUES('" + userid + "', '"  + pwd + "', '"  + name + "', '"  + phoneNum + "', '"  + email + "')";
